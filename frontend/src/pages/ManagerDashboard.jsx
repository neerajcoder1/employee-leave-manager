...
const ManagerDashboard = () => {
    ...
    try {
      ...
      if (leavesData.success) {
        ...
        if (pendingCountRef.current === -1) {
          ...
          const newNotifs = Array(newCount).fill({
          ...
          addToast(
            "success",
            "New Request",
            `${newCount} new leave request${newCount > 1 ? "s" : ""} submitted.`,
          );
        }
    ...
    try {
      ...
      setTimeout(() => {
        ...
        addToast(
          "success",
          "Deleted",
          "Leave request has been permanently deleted.",
        );
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchQuery, employeeSearchQuery, statusFilter, employeeSortBy]);
  ...
  const leaveTypeDistribution = useMemo(() => {
    ...
    return [
      {
        name: "Annual",
        value: counts["Annual Leave"] || 0,
        color: "var(--accent-color)",
      },
      {
        name: "Sick",
        value: counts["Sick Leave"] || 0,
        color: "var(--warning-color)",
      },
      {
        name: "Maternity",
        value: counts["Maternity Leave"] || 0,
  ...
  return (
    <div className="dashboard-container">
      ...
      <section className="hero-grid" style={{ marginBottom: "2.5rem" }}>
        ...
        >
          ...
          <p className="saas-subtitle">
            Manage employee leave requests, monitor team activity and track
            organizational leave statistics.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                style={{ fontWeight: "600", color: "var(--warning-color)" }}
              >
      ...
      <section style={{ marginBottom: "2.5rem" }}>
        ...
        <div
          className="quick-actions-grid blur-reveal"
        ...
        >
          ...
          >
            <CheckCircle size={18} color="var(--success-color)" /> Approve
            Requests
          </button>
          <button
            className="action-btn hover-scale"
          ...
          >
            <History size={18} color="var(--text-secondary)" /> View Leave
            History
          </button>
        </div>
      </section>
      ...
      {/* Enhanced KPI Cards */}
      <section
        className="metrics-row blur-reveal"
        style={{ animationDelay: "200ms", marginBottom: "2.5rem" }}
      >
        <div
          className="card-panel metric-mini-card hover-glow"
          style={{
      ...
      <div
        className="dashboard-main-grid blur-reveal"
        style={{ animationDelay: "250ms", marginBottom: "2.5rem" }}
      >
          ...
          {recentActivity.length > 0 ? (
            <div style={{ display: "flex", flexDirection: "column" }}>
              {recentActivity.map((activity, index) => {
                ...
                const color =
                  actionColors[activity.status] || "var(--text-secondary)";

                let text = "";
                if (activity.status === "Pending")
                  text = `${activity.username} submitted a leave request`;
                else if (activity.status === "Approved")
                  text = `Manager approved ${activity.username}'s request`;
                else text = `Manager rejected ${activity.username}'s request`;

                return (
                  <div
                    key={activity.id || index}
                    className="activity-item hover-scale"
                  >
                    <div
                  ...
                  {currentLeavesRows.map((leave) => {
                    ...
                    return (
                      <tr
                        key={leave.id}
                        className={
                          deletingLeaveId === leave.id ? "deleting-row" : ""
                        }
                      >
                        <td>
                          <div
                          ...
                          >
                            ...
                            <button
                              ...
                              style={{
                                ...
                                color: "var(--danger-color)",
                                opacity:
                                  deletingLeaveId === leave.id ? 0.5 : 0.8,
        ...
        <div className="modal-overlay" onClick={() => setLeaveToDelete(null)}>
          ...
          >
            ...
            >
              ...
              <strong>{leaveToDelete.username}</strong>'s{" "}
              {leaveToDelete.leave_type} request? This action cannot be undone.
            </p>
            <div
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontWeight: "500", fontSize: "0.85rem" }}>
                    {viewEmployeeProfile.username.toLowerCase()}@gcu.in
                  </span>
                </div>
                <div
                  style={{ display: "flex", justifyContent: "space-between" }}
              ...
              >
                <div
                  style={{
                    flex: 1,
                    background: "hsla(263.4, 70%, 60%, 0.1)",
                    border: "1px solid hsla(263.4, 70%, 60%, 0.3)",
                    padding: "1rem",
                    borderRadius: "8px",
                  }}
                >
                  ...
                  >
                    {viewEmployeeProfile.annual_leave}
                  </div>
                  <div
                ...
                <div
                  style={{
                    flex: 1,
                    background: "hsla(142.1, 70.6%, 48%, 0.1)",
                    border: "1px solid hsla(142.1, 70.6%, 48%, 0.3)",
                    padding: "1rem",
                    borderRadius: "8px",
                  }}
                >
                  ...
                  >
                    {viewEmployeeProfile.sick_leave}
                  </div>
                  <div
                    style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}
                  >
